...
public class BoardDAO {
	...
	private final String BOARD_DELETE = "delete board where set = ?";
	...
	// select한 값을 담기 위해 rs, pstmt, conn 객체를 모두 사용해야 한다.
	public List<BoardDTO> getBoardList(BoardDTO dto) {
		// 중요 : ArrayList 는 While 블락 밖에서 선언
		//       ArrayList 에 저장되는 BoardDTO 선언은 while 블락 내에서 선언
		...
		try {
			...
			// System.out.println("DB Seleect 성공");
			...
			System.out.println("DB Seleect 실패");
