...
<body>
	<!-- Form 태그 내부에서 사용되는 태그들 : client = (get, post) ==> Server 전송
		- input : 
			...
			type = "checkbox"   : 다중 선택, 각각 변수명을 정의
			type = "file" 		: 파일, 그림, 문서를 서버로 전송
			type = "button" 	: 자바스크립트를 호출 후에 submit을 적용할 때
		...
		<table width = "900px">
			...
			<tr> <td align = "right"> 아이디 : </td> 
				<td> <input type = "text" name = "id" placeholder = "아이디를 입력해 주세요"> 
					<input type = "button" value = "아이디 중복 체크" name = "id check">
				</td>
			</tr>
			<tr> <td align = "right"> 패스워드 : </td> 
				<td> <input type = "password" name = "pass1" placeholder = "비밀번호를 입력해 주세요"> </td>
			</tr>
			<tr> <td align = "right"> 패스워드 확인 : </td> 
				<td> <input type = "password" name = "pass2" placeholder = "비밀번호를 한번 더 입력해 주세요"> </td>
			</tr>
			<tr> <td align = "right"> 성별 :  </td> 
				<td> <input type = "radio" name = "sex" value = "m"> 남성     <!-- radio는 변수명을 동일 -->
					 <input type = "radio" name = "sex" value = "w"> 여성
				</td>
			</tr>
			<tr> <td align = "right"> 취미 : </td> 
				<td> <input type = "checkbox" name = "hobby1" value = "m1"> 음악감상 &nbsp;&nbsp;  <!-- checkbox는 변수명을 다르게 -->
			...
			<tr> <td align = "right"> 휴대전화 : </td> 
				<td> 
					<select name = "nation">
						...
						<option value = "005"> 캐나다 </option>
						<option value = "046"> 영국 </option>
						<option value = "041"> 사우디 </option>
					</select>
					-
					<select name = "zone">
			...
			<tr> <td colspan = "2" align = "center"> 
				<input type = "reset" value = "다시 작성(리셋)"> &nbsp;&nbsp;
